	...
	for (i = 0; i < nodos.length; i++) {
		...
		for(var x=0;x<2;x++){
			for(var y=0;y<10;y++){
				...
				context.drawImage(obstaculo,(160+xi)-(largura/2),(135+yi)-(largura/2),largura,largura);
			}
		}
		...
		for(var x=0;x<2;x++){
			for(var y=0;y<10;y++){
				xi=distance+x*(largura+distance);
				yi=distance+y*(largura+distance);
				context.drawImage(obstaculo,(435+xi)-(largura/2),(135+yi)-(largura/2),largura,largura);
			}
		}
	}
}	
...
function detectarColisoes() {
	...
	for(var x=0;x<2;x++){
		for(var y=0;y<10;y++){
			xi=distance+x*(largura+distance);
			yi=distance+y*(largura+distance);
			if(snakeX==(160+xi)-(largura/2) && snakeY==(yi+135)-(largura/2))
				executarGameOver(); //Game Over!
		}
	}
	...
	for(var x=0;x<2;x++){
		for(var y=0;y<10;y++){
			xi=distance+x*(largura+distance);
			yi=distance+y*(largura+distance);
			if(snakeX==(435+xi)-(largura/2) && snakeY==(yi+135)-(largura/2))
				executarGameOver(); //Game Over!
		}
	}
...
function colisaoFruta() { //Verificar se posição da fruta colide com corpo da snake
	...
	for(var x=0;x<2;x++){
		for(var y=0;y<10;y++){
			xi=distance+x*(largura+distance);
			yi=distance+y*(largura+distance);
			if(realXFruta==(160+xi)-(largura/2) && realYFruta==(yi+135)-(largura/2))
				return true;
		}
	}
	...
	for(var x=0;x<2;x++){
		for(var y=0;y<10;y++){
			xi=distance+x*(largura+distance);
			yi=distance+y*(largura+distance);
			if(realXFruta==(435+xi)-(largura/2) && realYFruta==(yi+135)-(largura/2))
				return true;
		}
	}
